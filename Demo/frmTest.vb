...
#End Region
    ...
    Private Sub frmLauncher_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        EveSliderItem1.Images.Add(New EveImages(My.Resources._1981_Gallipoli_Poster1, "https://www.google.com.my/"))
        EveSliderItem1.Images.Add(New EveImages(My.Resources._1982_The_Escape_Artist_Poster1, "https://www.youtube.com/"))
        EveSliderItem1.Images.Add(New EveImages(My.Resources._1983_Videodrome_Poster2, "https://twitter.com/"))
        EveSliderItem1.Images.Add(New EveImages(My.Resources._3_Stooges_Poster3, "https://www.facebook.com/"))

        frmLoginTest.Show()
    End Sub

    Private Sub EveControlButtons1_HelpPressed(sender As Object, e As EventArgs) Handles EveControlButtons1.HelpPressed
        MsgBox("Help Pressed!")
    End Sub

    Private Sub EveButton2_Click(sender As Object, e As EventArgs) Handles EveButton2.Click
        frmOthers.Show()
    End Sub

    Private Sub EveFALabel1_Click(sender As Object, e As EventArgs) Handles EveFALabel1.Click
        frmSetting.Show()
    End Sub

    Private Sub EveButton1_Click(sender As Object, e As EventArgs) Handles EveButton1.Click
        EveMessageBox.ShowYesNo("F.StartPosition = FormStartPosition.CenterParent", MessageBoxIcon.Warning, "Error!!")
    End Sub
End Class
